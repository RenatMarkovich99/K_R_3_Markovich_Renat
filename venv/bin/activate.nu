...
def-env activate-virtualenv [] {
    ...
    let virtual_env = '/home/renat/PycharmProjects/K_R_3 Маркович Ренат/venv'
    let bin = 'bin'
    let path_sep = ':'
...
alias deactivate = source '/home/renat/PycharmProjects/K_R_3 Маркович Ренат/venv/bin/deactivate.nu'
